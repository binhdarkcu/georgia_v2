...
class Featured_Post
{
		...
		jQuery(document).ready(function($){
			$(\'.featured-post-toggle\').on("click",function(e){
				...
				$.ajax({url:ajaxurl,data:data,type:\'post\',
					...
					$(\'.featured-post-toggle\').removeClass(\'dashicons-star-filled\').addClass(\'dashicons-star-empty\');
					
					if(data.new_status=="yes"){
						_el.addClass(\'dashicons-star-filled\').removeClass(\'dashicons-star-empty\');
					}else{
    ...
    function admin_ajax() {
        ...
        delete_post_meta_by_key('_is_featured');
