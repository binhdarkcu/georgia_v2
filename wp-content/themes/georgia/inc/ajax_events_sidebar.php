...
add_action("wp_ajax_user_events_month", "user_events_month_callback");
add_action("wp_ajax_nopriv_user_events_month", "user_events_month_callback");

function user_events_month_callback() {
    $data_month = sprintf('%02d', $_REQUEST["data_month"]) ;
    $data_year = $_REQUEST["data_year"];
