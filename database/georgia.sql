...
--
-- Host: localhost
-- Generation Time: May 04, 2015 at 12:53 AM
...
INSERT INTO `wp_members` (`id`, `p_naam`, `p_voornaam`, `p_geboortedatum`, `p_geboorteplaats`, `p_straat`, `p_nr`, `p_postcode`, `p_plaats`, `p_land`, `p_telefoon`, `p_fax`, `p_gsm`, `p_email`, `p_likedin`, `p_picture`, `b_naam`, `b_hoofd`, `b_firma`, `b_straat`, `b_nr`, `b_postcode`, `b_plaats`, `b_land`, `b_telefoon`, `b_fax`, `b_gsm`, `b_email`, `b_organisatie`, `b_functies`, `r_naam`, `r_voornaam`, `r_telefoon`, `r_email`, `r_naam_2`, `r_voornaam_2`, `r_telefoon_2`, `r_email_2`, `f_personname`, `f_telefoon`, `f_fax`, `f_email`, `f_btw`, `f_interest`, `f_addresspayment`, `f_notepayment`, `created`, `modified`) VALUES
(1, 'aa', 'bb', 'cc', '123', 'df', 'sa', 'a', 'a', 'Partnership', '0967891344', '12345', 'aa', 'binhdarkcu@gmail.com', '123', 'eventica-header-dummy-01.jpg', 'aa', 'a', 'Partnership', 'a', '123', 'a', 'a', 'Partnership', '0967891344', '12345', 'aa', 'binhdarkcu@gmail.com', 'baa', 'aa', 'a', 'e', 'a', 'binhdarkcu@gmail.com', 'b', 'c', 'a', 'binhdarkcu@gmail.com', 'a', '0967891344', '11', 'binhdarkcu@gmail.com', 'ads', '', 'on', 'aaa', '2015-05-03 04:28:46', '2015-05-03 04:28:46');
...
(428, '_transient_timeout_dash_4077549d03da2e451c8b5f002294ff51', '1430714740', 'no'),
(429, '_transient_dash_4077549d03da2e451c8b5f002294ff51', '<div class="rss-widget"><ul><li><a class=''rsswidget'' href=''https://wordpress.org/news/2015/04/wordpress-4-2-1/''>WordPress 4.2.1 Security Release</a> <span class="rss-date">April 27, 2015</span><div class="rssSummary">WordPress 4.2.1 is now available. This is a critical security release for all previous versions and we strongly encourage you to update your sites immediately. A few hours ago, the WordPress team was made aware of a cross-site scripting vulnerability, which could enable commenters to compromise a site. The vulnerability was discovered by Jouko Pynnönen. [&hellip;]</div></li></ul></div><div class="rss-widget"><ul><li><a class=''rsswidget'' href=''http://z9.io/2015/05/03/matts-interview-in-the-sbp/''>Donncha: Matt’s interview in the SBP</a></li><li><a class=''rsswidget'' href=''http://ma.tt/2015/05/rip-dan-rip-dave/''>Matt: RIP Dan, RIP Dave</a></li><li><a class=''rsswidget'' href=''http://wptavern.com/belgrades-first-wordcamp-sells-out-plans-to-double-attendees-next-year''>WPTavern: Belgrade’s First WordCamp Sells Out, Plans to Double Attendees Next Year</a></li></ul></div><div class="rss-widget"><ul><li class=''dashboard-news-plugin''><span>Popular Plugin:</span> <a href=''https://wordpress.org/plugins/tablepress/'' class=''dashboard-news-plugin-link''>TablePress</a>&nbsp;<span>(<a href=''plugin-install.php?tab=plugin-information&amp;plugin=tablepress&amp;_wpnonce=fc9e19436e&amp;TB_iframe=true&amp;width=600&amp;height=800'' class=''thickbox'' title=''TablePress''>Install</a>)</span></li></ul></div>', 'no'),
